...
public final class ContactItemBinding implements ViewBinding {
  ...
  private ContactItemBinding(@NonNull LinearLayout rootView, @NonNull TextView contactName,
      @NonNull TextView contactPhoneNumber) {
  ...
  public static ContactItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.contactPhoneNumber;
      TextView contactPhoneNumber = ViewBindings.findChildViewById(rootView, id);
      if (contactPhoneNumber == null) {
        break missingId;
      }

      return new ContactItemBinding((LinearLayout) rootView, contactName, contactPhoneNumber);
    }
