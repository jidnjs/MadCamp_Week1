...
public final class ItemContactBinding implements ViewBinding {
  ...
  private ItemContactBinding(@NonNull ConstraintLayout rootView, @NonNull TextView tvContactName,
      @NonNull TextView tvContactPhoneNumber) {
  ...
  public static ItemContactBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemContactBinding((ConstraintLayout) rootView, tvContactName,
