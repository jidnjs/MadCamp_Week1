...
import com.example.refactor.ui.adapters.ImageAdapter
import com.example.refactor.ui.adapters.ImageInfoAdapter
...
//        imageAdapter = ImageAdapter(requireContext(), images)
        recyclerView.apply{
            layoutManager = GridLayoutManager(requireContext(), 2) // 3 columns in the grid
...
//        val closeButton = dialogView.findViewById<Button>(R.id.close_button) // changed: reference to close button
        ...
        recyclerView.apply{
            ...
            adapter = ImageInfoAdapter(DummyImageInfo.getDummyImageInfo()) // Use dummy data for now
        }
